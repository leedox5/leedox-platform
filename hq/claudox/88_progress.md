...
**완료(✅): 19 / 20 (95%) · 🟡 실습 전 시나리오: 1개(18) · 전체 평균 완성도: 88.5%**

*완성도는 챕터가 해당 주제의 기승전결을 얼마나 갖췄는지에 대한 정성적 평가치이며, ✅ 상태는 80% 이상을 기준으로 표시한다. 🟡는 실제로 겪은 일이 아니라 앞으로 실습해볼 시나리오로 미리 써둔 챕터(18) — 실제로 해보면 ✅로 갱신할 것. 🔵(15장 전용, 2026-07-26 신설 — 가상 시나리오가 아니라 실제로 진행 중인 이야기이지만 아직 완결되지 않은 챕터)는 2026-07-26 다상품 플랫폼 일반화 PR(#9) 병합·프로덕션 검증 완료로 15장이 ✅로 전환되며 현재 적용 챕터 없음.*

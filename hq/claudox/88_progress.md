...
| 11 | 버그를 함께 잡다 | [11_bugfix.md](11_bugfix.md) | 97% | ✅ |
| 12 | 테스트 코드를 짜다 | [12_testing.md](12_testing.md) | 90% | ✅ |
| 13 | 리팩토링 실전 | [13_refactoring.md](13_refactoring.md) | 85% | ✅ |
| 14 | Git 워크플로우와 커밋 메시지 | [14_git_workflow.md](14_git_workflow.md) | 85% | ✅ |
| 15 | Pull Request를 만들다 | [15_pull_request.md](15_pull_request.md) | 95% | ✅ |
...
| 18 | 스킬(Skill)로 반복 작업 줄이기 | [18_skill_automation.md](18_skill_automation.md) | 92% | ✅ |
| 19 | 보안 리뷰 체크리스트 | [19_security_review.md](19_security_review.md) | 90% | ✅ |
| 20 | 마무리 — 극대화된 생산성, 그 이후 | [20_wrap_up.md](20_wrap_up.md) | 90% | ✅ |

**완료(✅): 20 / 20 (100%) · 🟡 실습 전 시나리오: 없음 · 전체 평균 완성도: 90.5%**

*완성도는 챕터가 해당 주제의 기승전결을 얼마나 갖췄는지에 대한 정성적 평가치이며, ✅ 상태는 80% 이상을 기준으로 표시한다. 🟡는 실제로 겪은 일이 아니라 앞으로 실습해볼 시나리오로 미리 써둔 챕터를 뜻했고, 마지막 하나였던 18장이 2026-08-22 `leedox-handoff` 스킬을 실제로 만들면서 ✅로 전환돼 현재 적용 챕터 없음. 🔵(15장 전용, 2026-07-26 신설 — 가상 시나리오가 아니라 실제로 진행 중인 이야기이지만 아직 완결되지 않은 챕터)는 2026-07-26 다상품 플랫폼 일반화 PR(#9) 병합·프로덕션 검증 완료로 15장이 ✅로 전환되며 현재 적용 챕터 없음.*

# S01E07: 자율 디버깅과 자동화 테스트: 에러 발생 시 자율 수정 루프
...
## 🔗 다음 에피소드 안내
- **S01E08 (정규)**: [GitHub MCP & 자동화 파이프라인: 무중력 릴리즈와 상품화](file:///d:/0002/hq/aigravity/S01E08_github_mcp_productization.md)
